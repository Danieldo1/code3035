...
const SnackPageAdmin = () => {
    ...
    const saveOrderSmoke = async () => {
        ...
        try {
          const response = await fetch('/api/snack-categories/updateOrder', {
            method: 'PUT',
            headers: {
              'Content-Type': 'application/json',
            },
       ...
       const handleDelete = async (_id) => {
        const deletePromise = new Promise( async(resolve, reject) => {
         const response=   await fetch('/api/snack-categories?_id='+_id, {
               method: 'DELETE',
               headers: {
                   'Content-Type': 'application/json'
               },
