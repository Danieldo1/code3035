  ...
  return (
    <section className='mt-10'>
        ...
        <div className='mt-5 text-center justify-center items-center'>
            <h3 className='text-xl font-bold'>We are open daily !</h3>
            ...
            <br />
            <p className='text-md text-gray-100'>Book a table by calling us today <br/><a href='tel:+35797866197'>+357-97-866-197</a> </p>
